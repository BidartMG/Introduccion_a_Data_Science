...
| En esta lección conocerás las maneras de acceder a las estructuras de datos en
| el lenguaje R.
...
|==                                                                     |   4%
| Tú puedes obtener un elemento o múltiples elementos de una estructura de datos
| usando la notación de indexado de R.
...
| 1 y no en 0, como en lenguajes de programación como Java o C.
...
| ¡Todo ese trabajo está rindiendo frutos!
  ...
  |================                                                       |  23%
| Como un caso especial, puedes usar la notación [[]] para referirte a un solo
| elemento. Ingresa mi_vector[[3]] en la línea de comandos.
...
|===================                                                    |  26%
| También puedes usar enteros negativos para obtener un vector que consista en
...
| ¡Sigue trabajando de esa manera y llegarás lejos!
  ...
  |====================                                                   |  28%
| Como alternativa a indexar con un vector de enteros, puedes indexar a través
| de un vector lógico.
...
| ¡Eres bastante bueno!
  ...
  |======================                                                 |  32%
| Como podrás notar, lo que ocurrió fue que indexaste únicamente los elementos
...
|========================                                               |  33%
| El vector índice no necesita ser de la misma longitud que el vector a indexar.
| R repetirá el vector más corto y regresará los valores que cacen. Ingresa
...
|==========================                                             |  37%
| Es muy útil calcular un vector lógico de un mismo vector. Por ejemplo, busca
| elementos más grandes que 20. Ingresa en la línea de comandos mi_vector > 20.
...
|===============================                                        |  44%
| Para crear un arreglo de dimensión 3x3x2 y de contenido los números del 1 al
...
| 3 renglones y 3 columnas con los números enteros del 1 al 9 y guárdala en la
| variable 'mi_matriz'.
...
| una dimensión de una matriz, simplemente omite los índices.
...
| ¡Excelente trabajo!
  ...
  |=========================================                              |  58%
| También puedes referirte a un rango de renglones. Ingresa mi_matriz[2:3,] en
...
| muchos otros lenguajes. Las listas en R contienen una selección heterogénea de
...
| ¡Excelente trabajo!
  ...
  |===================================================                    |  72%
| Además, puedes usar la notación [] para indexar un conjunto de elementos por
| nombre. Ingresa carro[c("ncilindros","nllantas")] en la línea de comandos.
...
| ¡Tu dedicación es inspiradora!
  ...
  |====================================================                   |  74%
| También puedes indexar por nombre usando la notación [[]] cuando seleccionas
| un simple elemento. Por ejemplo, ingresa carro[["marca"]] en la línea de
| comandos.
...
| ¡Acertaste!
  ...
  |===========================================================            |  82%
| Tú puedes usar la notación [[]] para referirte a un elemento en este tipo de
| estructura de datos. Para hacer esto usa un vector como argumento. R iterará a
| través de los elementos en el vector referenciando sublistas.
...
| tomadas en la década de 1920; estas observaciones describen la velocidad (mph)
| de algunos carros y la distancia (ft) que les tomó parar.
...
#                                                       | lista) por nombre usando el operador $. Ingresa cars$speed en la línea de
# | comandos.
...
#   
#   |==================================================================     |  93%
# | Supón que deseas saber a qué velocidad iban los carros a los que les tomó más
...
| vector de valores booleanos para especificar cuál o cuáles elementos regresar
| de la lista. La manera de calcular el vector apropiado es así: cars$dist>100.
| ¡Inténtalo!
...
Selection: 2
Â¿CÃºal es tu nombre de usuario registrado en Coursera (email)? monica.bidart@gmail.com
Â¿CÃºal es tu token de la tarea? XEccE7RBmCt8TH1c
Â¡El envÃ­o de la calificaciÃ³n fue satisfactorio!
  
  | ¡Eso es trabajo bien hecho!
  
  | ¡Has alcanzado el fin de esta
| lección! Volviendo al menú
| principal...
...
3: ¡Llévame al depósito de cursos swirl!
